  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['2025-02-11', 'Session 3', '21', '13', 'not admin', '[[02 §S3-O]]'],
        ['2025-03-04', 'Session 5', '19', '12', 'not admin', '[[02 §S5-O]]'],
        ...
        ['2025-05-22', 'ED presentation', 'not admin', 'not admin', 'Item 5', '[[03 §Addendum]] [[05 §Outcome table]]'],
